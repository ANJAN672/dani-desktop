...
export const GROUP_GOAL_CONTROL_OPEN = "<dani-goal>";
export const GROUP_GOAL_CONTROL_CLOSE = "</dani-goal>";
...
export function groupGoalWorkerInstructions(args: {
  ...
  return [
    ...
    `Address your result to ${args.coordinatorName}. Do not invent a new orchestration protocol or emit an dani-goal control envelope.`,
  ].join("\n");
}
