...
//
// Protocol: the Dani Bot proxies speak raw JSON-RPC 2.0 over stdio, one
 ...
 * Keeping it local avoids bundling Pi into Dani Bot; the extension is
...
/** A minimal stdio JSON-RPC 2.0 MCP client, matched to Dani Bot's
