...
const controlUrl = (process.env.DANI_CONTROL_URL ?? process.env.OMB_CONTROL_URL) ?? "";
const controlToken = (process.env.DANI_CONTROL_TOKEN ?? process.env.OMB_CONTROL_TOKEN) ?? "";
