...
/** Pairing tokens may travel through a verified Dani Bot HTTPS endpoint or
...
export async function pairDesktopCompanion({
  ...
  if (!endpoint) {
    throw new Error("Enter the Dani Bot HTTPS companion address or full Tailscale name ending in .ts.net");
  }
