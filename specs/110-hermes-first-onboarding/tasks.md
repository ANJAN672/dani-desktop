...
- [ ] T-RUNTIME-001 [R-RUNTIME-004] Enforce Hermes-only release selection and migrate stale bot selections. Mutation-boundary rejection landed; deterministic migration of stale bot selections is NOT done.
