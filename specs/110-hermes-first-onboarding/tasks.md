...
- [ ] T-RUNTIME-001 [R-RUNTIME-004] Enforce Hermes-only release selection and migrate stale bot selections.
- [ ] T-MODEL-001 [R-MODEL-005] Implement live free/local capability and billing probes with no paid fallback.
- [ ] T-UI-001 [R-UI-001,R-UI-002] Replace onboarding engine choice with the bootstrap status state machine.
