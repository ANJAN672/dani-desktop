...
public struct PairingRouteError: Error, LocalizedError, Equatable, Sendable {
    ...
    public var errorDescription: String? {
        ...
        return "Couldn’t reach this computer through any available route (\(routes)). Keep Phone access turned on in Dani Bot, then try again."
    }
}
...
public struct CompanionClient: Sendable {
    ...
    /// Only the first response that identifies itself as Dani Bot receives
